          ...
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
            ...
            <tr>
              <td class="content" style="padding: 30px 20px;">
                ...
                <p style="margin-top: 10px; margin-bottom: 20px;">We're thrilled to confirm your subscription to <strong>Raflinks</strong>! Thank you for choosing us to help you track, manage, and monetize your links effortlessly.</p>
                ...
                <div class="details" style="margin-top: 20px; background-color: #f9f9f9; padding: 15px 20px; border-left: 4px solid #1b3b36; border-radius: 4px;">
                  <p style="margin: 8px 0;"><strong>Amount Paid:</strong> {amount} USD</p>
                  <p style="margin: 8px 0;"><strong>Payment Method:</strong> {cardType} ending in {last4}</p>
